...
# Title: Test
# Generated: Fri Oct 30 18:14:13 2015
##################################################
...
class test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.nuts_ngham_encoder_0 = nuts.ngham_encoder("packet_len", False, False)
        ...
        self.connect((self.digital_gmsk_mod_0, 0), (self.blocks_null_sink_0, 0))    
